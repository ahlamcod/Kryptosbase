...
function CiphersPage() {
    const [selectedCipher, setSelectedCipher] = useState("Ceaser Cipher"); //hook useState() to store the current selection
  return (
    <>
...
{/* Conditional Rendering */}
  ...
  <br />Ciphertext = EVLNXACDTXESEAXROFOXDEECXWIREE
        ...
        <p className="mr-[50px] text-black text-[24px]">
           ...
           <br />where:
           <ul>
            <ol>P= plaintext letter (0–25)</ol>
            <ol>a, b= keys (a must be coprime with 26),</ol>
            <ol>C= ciphertext letter</ol>
           </ul>
